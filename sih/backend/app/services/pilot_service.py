...
class PilotService:
    ...
    def format_pilot_response(cls, pilot: Pilot) -> PilotResponse:
        ...
        return PilotResponse(
            ...
            title=pilot.title,
            pilot_title=pilot.pilot_title or pilot.title,
            scope_of_work=pilot.scope_of_work,
            scope=pilot.scope or pilot.scope_of_work,
            duration_weeks=pilot.duration_weeks,
            duration_days=pilot.duration_days or (pilot.duration_weeks * 7 if pilot.duration_weeks else 90),
            sandbox_location=pilot.sandbox_location,
            pilot_location=pilot.pilot_location or pilot.sandbox_location,
            approved_budget=float(pilot.approved_budget or 0.0),
            pilot_budget=float(pilot.pilot_budget or pilot.approved_budget or 0.0),
            status=pilot.status,
            approval_status=getattr(pilot, "approval_status", "APPROVED") or "APPROVED",
            success_status=getattr(pilot, "success_status", "NOT_ASSESSED") or "NOT_ASSESSED",
