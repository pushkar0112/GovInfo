"""0005_pilot_milestone_deliverable_system

Revision ID: 0005_pilot_milestone_deliverable_system
Revises: 0004_expert_evaluation_system
...
revision: str = "0005_pilot_milestone_deliverable_system"
down_revision: Union[str, None] = "0004_expert_evaluation_system"
...
def upgrade() -> None:
    ...
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='pilots' AND column_name='scope') THEN
...
def downgrade() -> None:
    op.execute("DROP TABLE IF EXISTS pilot_deliverables CASCADE;")
